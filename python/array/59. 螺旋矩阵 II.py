...
"""
思考
1. 建议把x, y换成row, col，这样不会受坐标系里x代表“横向”习惯的影响
2. 方向的转化是状态机，但是这个状态机不复杂，因此用循环就可以办到。 dirs = [(0, 1), (1, 0), (0, -1), (-1, 0)]，通过取余让dirIndex在[0...3]循环就行
3. needTurn没有冗余逻辑，对比答案只是抽出成了一个函数，没什么问题
"""